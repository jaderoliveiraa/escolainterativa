...
<body>
    ...
    <form class="form-horizontal" action="../controllers/controllerAluno.php" method="POST">
        <fieldset>
            <div class="panel panel-primary">
               <div class="panel-heading panel-primary">Cadastro de Alunos</div>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <?php
                        require_once '../views/formCadUsuariosInterno.php';
                        ?>
