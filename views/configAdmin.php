...
<html>
    ...
    <body>
        <form method="POST" action="../controllers/controllerConfig.php">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col col-md-10">
                                            <input id="cnpj" name="cnpj" placeholder="" class="form-control input-md" required="" type="text" value="<?php echo $dado['cnpj'] ?>">
                                        </div>
                                    </div>
                                    <!-- Endereço -->
                                    <div class="row">
                                        ...
                                        <div class="col col-md-10">
                                            <input id="endereco" name="endereco"  class="form-control input-sm"  type="text" maxlength="10"  value="<?php echo $dado['endereco'] ?>">
                                        </div>
                                    </div>
                                    <!-- Telefone  -->
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <input id="site" name="site" class="form-control" type="text" value="<?php echo $dado['website'] ?>">
                                        </div>
                                    </div>
                                    <!-- responsável -->
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <input id="responsavel" name="responsavel" class="form-control"  type="text" value="<?php echo $dado['responsavel'] ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-success" ><b>Alterar</b></button>
                                    </div>
                                    </br>
                                    </br>
                                </div>                    
